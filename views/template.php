...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"> <?= $AlexanderPierce = "Alexander Pierce"?></a>
        </div>
      </div>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020-2021 <a href="#">YosukoDelivery</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
